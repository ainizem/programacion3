...
public class Usuario {
	...
	public Usuario(String nombre, String apellidos, String email, String telefono, String usuario, String contrasena,
			int rol) {
		super();
		this.nombre = nombre;
	...
	public String toString() {
		return "UsuarioDAO [nombre=" + nombre + ", apellidos=" + apellidos + ", email=" + email + ", telefono="
				+ telefono + ", usuario=" + usuario + ", contrasena=" + contrasena + ", rol="+rol+"]";
	}
